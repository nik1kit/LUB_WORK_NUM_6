...
int main()
{
    ...
    BigRational rational(5, 3);
    double value = rational.to_double();
    ...
    std::cout << "double cast: " << value << std::endl;
    return 0;
}
